...
const note = "M345.47,250L460.94,450L230,450Z M460.94,50L576.41,250L345.47,250Z M576.41,250L691.88,450L460.94,450Z"

const paths = [lightning, hand, heart, star, lightning]
const colors = [
    "#fff312",
    "#dd00ee",
    "#9911ff",
