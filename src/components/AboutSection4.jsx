...
const AboutSection4 = () => {
  ...
  return (
    ...
    <div className=" mt-40 p-3 grid grid-cols-4 gap-9 ">
        {data.map((item,i)=>{
            return(
                <div  key={i}>
      <div className="flex w-[300px] ">
        <div className="text-[64px]"><Counter value={item.value1} /></div>
        <div className="text-[48px] text-secondary">{item.value2}</div>
      </div>
      <div className="text-[24px] border-b border-gray-700 pb-2">
      {item.title}
      </div>
